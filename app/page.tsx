      ...
      <section className="px-4 py-52 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <p className="mt-8 text-xl leading-8 text-muted-foreground max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-200">
            Discover Nike's legendary footwear collection. From iconic Air Max to revolutionary ZoomX, 
            unleash your potential with shoes that combine innovation, style, and performance.
          </p>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center mb-16">
            <h2 className="text-base font-semibold leading-7 text-primary">Nike Collection</h2>
      ...
      <section className="py-32 sm:py-40 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Nike Advantage</h2>
            <p className="mt-2 text-4xl font-bold tracking-tight sm:text-5xl">
...
const features = [
  {
    ...
    description: 'Cutting-edge materials and Nike Air technology deliver unmatched comfort and performance for every athlete.',
    icon: <Zap className="h-5 w-5 text-primary" />,
  },
  {
    name: 'Nike Craftsmanship',
    description: 'Precision-engineered designs featuring Flyknit technology and dynamic support for ultimate performance.',
    icon: <Server className="h-5 w-5 text-primary" />,
  },
  {
    name: 'Nike Quality',
    description: 'Every Nike product undergoes extensive testing to ensure it meets our highest standards of excellence and durability.',
